...
export const musicRooms: MusicRoom[] = [
  {
    ...
    pageCount: 3, currentPage: 1, hasAnnotations: true,
    songForm: ['주의 이름 높이며', '살아계신 주', '예수 우리 왕이여'],
    isClosed: false,
    createdBy: '김강래', lastActivity: '방금 전',
  },
  {
    ...
    key: 'E',
    activeUsers: [],
    pageCount: 2, currentPage: 1, hasAnnotations: true,
    songForm: ['여호와 이레', '하나님의 은혜'],
    isClosed: true,
    createdBy: '김강래', lastActivity: '4월 1일',
  },
  {
    ...
    key: 'D',
    activeUsers: [],
    pageCount: 2, currentPage: 1, hasAnnotations: false,
    songForm: ['은혜 (Grace)', '날 향한 약속'],
    isClosed: false,
    createdBy: '최기현', lastActivity: '4월 7일',
  },
];
